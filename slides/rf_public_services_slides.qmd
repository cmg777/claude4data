...
## Third Best: Tuberculosis Incidence {.smaller}
...
- Number of new TB cases per 100,000 population
- Year: 2017
- Unit: cases per 100,000 inhabitants

**Why satellite imagery predicts it well:**

- TB correlates with housing density and overcrowding
- Poverty patterns visible in building structures
- Urban slums and informal settlements detectable
- Access to healthcare (diagnosis rates) tied to urbanization
:::
...
## Worst Predicted: School Dropout Rate (Female) {.smaller}

**R² = -0.588** (worst predictability)

::: {.columns}
::: {.column width="60%"}
**How it's measured:**

- Percentage of female students dropping out of school
- Administrative education records
- Unit: % of enrolled female students

**Why satellite imagery fails to predict it:**

- Dropout driven by **socioeconomic factors** (poverty, early marriage, family obligations)
- **Policy interventions** vary independently of geography
- **Cultural factors** not visible in imagery
- No spatial correlation with physical infrastructure
:::
...
## Second Worst: Mass Transit Seats {.smaller}
...
- Number of seats available in mass public transit
- Year: 2012
- Unit: seats per municipality

**Why satellite imagery fails to predict it:**

- Mass transit is a **policy decision**, not geography-driven
- Bus/transit allocation depends on **political priorities**
- Small municipalities may have disproportionate transit
- **Budget allocation** varies independently of urban density
- Transit routes not visible in satellite imagery
:::
